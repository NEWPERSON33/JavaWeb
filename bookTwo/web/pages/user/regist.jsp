		...
		<script type="text/javascript">
			...
			$(function () {
				...
				$("#username").blur(function () {
					...
					$.getJSON("http://localhost:8080/bookTwo/User" , "action=ajaxExistUsername&username="+username , function (data) {
						if(data.existsName){
				...
				<div id="content">
					<div class="login_form">
						<div class="login_box">
							...
							<div class="form">
								<form action="http://localhost:8080/bookTwo/User" method="post">

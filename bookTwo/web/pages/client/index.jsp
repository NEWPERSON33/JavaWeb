	...
	<script type="text/javascript">
		$(function () {
			$("button.addToCart").click(function () {
				...
				$.getJSON("http://localhost:8080/bookTwo/cartservlet" ,"action=AjaxaddItem&id="+bookId , function (data) {
		...
		<div id="book">
			...
			<div style="text-align: center">
				<span id="cartTotalCount">您的购物车中有${empty sessionScope.cart.totalCount? 0:sessionScope.cart.totalCount}件商品</span>
					...
					<div>
						您刚刚将<span style="color: red" id="cartLastName">${sessionScope.lastItemname}</span>加入到了购物车中
					</div>


			</div>
			<for:forEach items="${requestScope.page.items}" var="book">
			<div class="b_list">
				<div class="img_div">
